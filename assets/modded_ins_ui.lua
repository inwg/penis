...
local function drawWindow(click, held, rightClick)
    ...
    do
        ...
        local tTop, tA = y + 22 - floor(tsz / 2), AL.text * v * expand
    ...
    local infoBottom = y + 38
    if ProjectState.subtitle ~= "" then
        txt(ProjectState.subtitle, hdrX, y + 40, WHITE, 11, FontSystem, 61, false, false, max(2, (x + sw - 14) - hdrX), AL.dim * v * expand)
        infoBottom = y + 54
    end
